        ...
        >
          <div className="container-fluid">
            ...
            <div className="main-menu__nav">
              <ul className="main-menu__list">
                ...
                <li className={`dropdown ${menu.features && "current"}`}>
                  ...
                  <ul>
                    <li>
                      <Link to="/personalloan">Personal Loan Calculator</Link>
                    </li>
                    <li>
                      <Link to="/homeloan">Home Loan Calculator</Link>
                    </li>
                    <li>
            ...
            <div className="main-menu__right">
              ...
              <Link to="apply-now.html" className="thm-btn main-menu__btn">
                Request Loan
              </Link>
        ...
        <div className="mobile-nav__content">
          ...
          <div className="mobile-nav__container">
            <ul className="main-menu__list">
              <li className="dropdown current">
                ...
                {/* {homeDrop && (
                  <ul style={{ display: "block" }}>
                    ...
                    <li>
                      <Link to="/home-03" onClick={() => setmobile(false)}>
                        Home Three
                      </Link>
                    </li>
                    <li className="dropdown">
                      ...
                      {headerDrop && (
                        <ul style={{ display: "block" }}>
                          ...
                          <li>
                            <Link to="/home3" onClick={() => setmobile(false)}>
                              Header Three
                            </Link>
                          </li>
                        </ul>
              ...
              <li className="dropdown">
                ...
                {pagesDrop && (
                  <ul style={{ display: "block" }}>
                    ...
                    <li>
                      <Link to="/teamdetails" onClick={() => setmobile(false)}>
                        Team Details
                      </Link>
                    </li>
                    <li>
                      <Link to="/creditrepair" onClick={() => setmobile(false)}>
                        Credit Repair
                      </Link>
                    </li>
                    <li>
                      <Link to="/creditaudit" onClick={() => setmobile(false)}>
                        Credit Audit
                      </Link>
                    </li>
                    <li>
                      <Link to="/careers" onClick={() => setmobile(false)}>
                        Careers
                      </Link>
                    </li>
                    <li>
              ...
              <li className="dropdown">
                <Link to="#" className={featuresDrop ? "expanded" : ""}>
                  Features
                  <button
                    aria-label="dropdown toggler"
                ...
                {featuresDrop && (
                  <ul style={{ display: "block" }}>
                    <li>
                      <Link to="/personalloan" onClick={() => setmobile(false)}>
                        Personal Loan
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/homeloan" onClick={() => setmobile(false)}>
                        Home Loan
                      </Link>
                    </li>
                    <li>
                      <Link
                        to="/homeloaneligilibity"
                        onClick={() => setmobile(false)}
                      >
                        Home Loan Eligibility
                      </Link>
                    ...
                    <li>
                      <Link to="/compareEMI" onClick={() => setmobile(false)}>
                        Compare EMI
                      </Link>
                    </li>
                    <li>
                      <Link
                        to="/monthlycalculator"
                        onClick={() => setmobile(false)}
                      >
                        Monthly Calculator
                      </Link>
